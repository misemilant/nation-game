...
{
  "id": 72,
  "title": "Polemik Pengalihan Anggaran Pendidikan untuk Program Makan Bergizi",
  "category": "Education",
  "description": "Laporan investigasi menyoroti kebijakan alokasi APBN pendidikan yang dialihkan untuk mendanai program Makan Bergizi Gratis (MBG), memicu kekhawatiran minimnya perbaikan fasilitas sekolah dan gaji guru.",
  "options": [
    {
      "text": "Kembalikan mandatory spending 20% APBN murni untuk kualitas sekolah dan peningkatan kesejahteraan guru.",
      "effects": {
        "education": 15,
        "civilLiberties": 5,
        "economy": -5
    ...
    {
      "text": "Lanjutkan integrasi program MBG di bawah anggaran pendidikan demi perbaikan gizi dan kesehatan anak sekolah.",
      "effects": {
        "health": 10,
        "education": -5,
        "economy": 5
...
{
  "id": 73,
  "title": "Ancaman Karhutla di Lahan Gambut & Gugatan Hak Udara Bersih",
  "category": "Environment",
  "description": "Laporan Greenpeace dan media mencatat peningkatan titik panas kebakaran hutan dan lahan (karhutla) di wilayah gambut, memicu kepulan kabut asap dan ancaman kesehatan masyarakat.",
  "options": [
    {
      "text": "Auditan total izin konsesi di lahan gambut, berikan sanksi pencabutan izin, dan pulihkan ekosistem basah.",
      "effects": {
        "environment": 15,
        "health": 10,
        "economy": -5
    ...
    {
      "text": "Fokus pada pemadaman udara (water bombing) tanpa menghentikan aktivitas ekonomi korporasi pemegang izin.",
      "effects": {
        "economy": 5,
        "environment": -10,
        "health": -5
...
{
  "id": 74,
  "title": "Krisis Penumpukan Sampah Kota & Deklarasi Sistem Guna Ulang",
  "category": "Environment",
  "description": "Penutupan TPA akibat overkapasitas mendorong koalisi lingkungan mengampanyekan sistem guna ulang (reuse) serta kewajiban produsen mengurangi kemasan sekali pakai.",
  "options": [
    {
      "text": "Wajibkan industri manufaktur beralih ke kemasan guna ulang dan berikan insentif bagi UMKM ramah lingkungan.",
      "effects": {
        "environment": 10,
        "infrastructure": 5,
        "economy": -5
    ...
    {
      "text": "Fokus pada perluasan lahan TPA baru dan teknologi insinerator pembakaran sampah skala besar.",
      "effects": {
        "infrastructure": 10,
        "environment": -5,
        "health": -5
...
{
  "id": 75,
  "title": "Penurunan Indeks Kebebasan Akademik di Perguruan Tinggi",
  "category": "Human Rights",
  "description": "Riset kebebasan akademis menunjukkan maraknya pembatasan diskusi kritis mahasiswa, intimidasi akademisi, serta intervensi birokrasi kampus oleh otoritas pemerintah.",
  "options": [
    {
      "text": "Jamin otonomi penuh kampus, lindungi hak mimbar akademik, dan hapus pasal pembatasan berekspresi.",
      "effects": {
        "civilLiberties": 15,
        "education": 10,
        "military": -5
    ...
    {
      "text": "Perketat pengawasan kegiatan kampus demi mencegah radikalisme dan menjaga stabilitas politik nasional.",
      "effects": {
        "military": 5,
        "civilLiberties": -10,
        "education": -5
...
{
  "id": 76,
  "title": "Gelombang Aksi Demonstrasi Buruh & Pengamanan Ketat Objek Vital",
  "category": "Social",
  "description": "Ribuan buruh menggelar demonstrasi menuntut peninjauan formula Upah Minimum Provinsi (UMP) dan penghapusan sistem kerja kontrak, diimbangi pengerahan ribuan personel pengamanan.",
  "options": [
    {
      "text": "Revisi regulasi pengupahan demi kenaikan UMP dan fasilitasi dialog tripartit antara buruh dan pengusaha.",
      "effects": {
        "civilLiberties": 10,
        "health": 5,
        "economy": -5
    ...
    {
      "text": "Pertahankan rumus pengupahan saat ini demi menjaga kepastian investasi dan ketertiban lalu lintas ekonomi.",
      "effects": {
        "economy": 10,
        "civilLiberties": -5
      }
...
{
  "id": 77,
  "title": "Akselerasi Transisi Energi Bersih Berbasis Komunitas Mandiri",
  "category": "Infrastructure",
  "description": "Kampanye independen mendorong percepatan Pembangkit Listrik Tenaga Surya (PLTS) Atap skala komunitas desa untuk mengurangi ketergantungan pada energi fosil.",
  "options": [
    {
      "text": "Berikan subsidi pemasangan panel surya rakyat dan kemudahan interkoneksi ke jaringan listrik nasional.",
      "effects": {
        "environment": 10,
        "infrastructure": 10,
        "economy": -5
    ...
    {
      "text": "Minta kompensasi biaya jaringan dari pemilik PLTS Atap demi melindungi pendapatan BUMN listrik negara.",
      "effects": {
        "economy": 5,
        "environment": -5,
        "infrastructure": -5
